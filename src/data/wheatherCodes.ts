...
export const WEATHER_CODES: Record<number, WeatherCondition> = {
    ...
    51: { code: 51, description: 'Light Drizzle', category: 'drizzle' },
    53: { code: 53, description: 'Moderate Drizzle', category: 'drizzle' },
    55: { code: 55, description: 'Dense Drizzle', category: 'drizzle' },
    56: { code: 56, description: 'Freezing Drizzle', category: 'drizzle' },
    57: { code: 57, description: 'Freezing Drizzle', category: 'drizzle' },
    61: { code: 61, description: 'Slight Rain', category: 'rain' },
    63: { code: 63, description: 'Moderate Rain', category: 'rain' },
    65: { code: 65, description: 'Heavy Rain', category: 'rain' },
